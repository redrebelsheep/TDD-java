...
public class RomanToDecimalTest {
    ...
    void parameterTest(String input, String expected) {
        Assertions.assertEquals(Integer.parseInt(expected), codeUnderTest.convert(input));
    }
    ...
    void methodReturnANumberTest() {
        ...
        int expected = 4;
        //WHEN
        int actual = codeUnderTest.convert("IV");
        //THEN
    ...
    public void subCovertRomanToDecimal(){
        ...
        // When
        int output = codeUnderTest.convert(inputValue);
        int output2 = codeUnderTest.convert(inputValue2);
